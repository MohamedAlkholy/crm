...
def registerPage(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # group = Group.objects.get(name="customer") # created by signals instead
...
def createOrder(request, pk):
    customer = Customer.objects.get(id=pk)
    # send multiple form in one form (Parent, child, fields, extra=no. of forms)
